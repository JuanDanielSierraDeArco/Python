...
print()
print("HI, Biennido {} calcularesmos el promedio de tu presupuesto en 5 meses".
      format(nombre))
print()
print(
    "Acontinuacion te voy a pedir el promedio de tus gastos en estos 5 meses. ")
